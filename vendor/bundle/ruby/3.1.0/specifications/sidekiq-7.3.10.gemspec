...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<redis-client>.freeze, [">= 0.23.0", "< 1"])
    s.add_runtime_dependency(%q<connection_pool>.freeze, [">= 2.3.0", "< 3"])
    ...
    s.add_dependency(%q<redis-client>.freeze, [">= 0.23.0", "< 1"])
    s.add_dependency(%q<connection_pool>.freeze, [">= 2.3.0", "< 3"])
