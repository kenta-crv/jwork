# -*- encoding: utf-8 -*-
# stub: carrierwave 3.1.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/carrierwaveuploader/carrierwave/blob/master/CHANGELOG.md" } if s.respond_to? :metadata=
